...
public class MainActivity extends AppCompatActivity {
    ...
    //donde mostramos las medidas
    private TextView mostrarMedidas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        servFake = new ServidorFake(this);

        servFake.GetMedidas(new CallbackMedidas() {
            @Override
            public void callbackMedidas(JSONArray response) {

                mostrarMedidas = findViewById(R.id.textView3);
                //muestre los datos del sql
                mostrarMedidas.setText(response.toString());
            }
        });
